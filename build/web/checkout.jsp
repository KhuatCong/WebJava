    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                <div class="container wrapper">
                    <div style="    margin: 2% 0;" class="row cart-head">
                        <div class="container">
                         ...
                         align-items: center;">
                                <h1 style="font-size:35px;" class="text-primary">Thanh toán</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row cart-body">
                        <form class="form-horizontal" onsubmit="return checkout()" action="checkout" method="post">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        Review Order <div class="pull-right"><small><a class="afix-1" href="carts">Edit
                                                    Cart</a></small></div>
                                    </div>
                                    <div class="panel-body">
                                        <c:forEach items="${requestScope.code}" var="book">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 col-xs-6">
                                                    <div style="color: #3b71ca;" class="col-xs-12">
                                                        ${book.getKey().tensach}</div>
                                                    <div class="col-xs-12"><small>Số lượng:
                                                            <span>${book.getValue()}</span></small></div>
                                                </div>
                                                <div class="col-sm-3 col-xs-3 text-right">
                                                    <input readonly="" type="hidden" name="price"
                                                        value="${(book.getKey().giaban - book.getKey().giaban*book.getKey().giamgia/100)*book.getValue()}">
                                                    <h6>
                                        ...
                                        <div class="form-group">
                                         ...
                                         height: 37px;" class="col-md-12">
                                                <input style="width:74%" type="text" oninput="changemagg()"
                                                    class="col-sm-6 col-xs-6" id="magg" name="magg"
                                                    placeholder="Mã giảm giá" value="" />
                                                <input style="width: 16%; display: flex;
                                               justify-content: center;color: white;
                                               background-color: #338dbc;
                                               border: none;
                                               border-radius: 3px;" onclick="checkgiamgia()" type="button"
                                                    class="col-sm-3 col-xs-3 text-right" value="Sử dụng" />
                                            </div>
                                            <div id="noti"
                                                style="margin-left: 2.5%;    margin-top: 1%; color:#ff6d6d;display: none"
                                                class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input style="width:74%" type="hidden" id="totalreal" name="total"
                                                    value="" />
                                                <input style="width:74%" type="hidden" id="nomal" name="totalfirst"
                                                    value="" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="hoten"
                                                    value="${sessionScope.account.hoten}" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input required="" type="text" class="form-control" id="adress" value=""
                                                    placeholder="Số nhà, đường" />
                                            </div>
                                            <div class="col-md-12">
                                                <input required="" type="hidden" class="form-control" id="adressreal"
                                                    name="diachi" value="" placeholder="Số nhà, đường" />
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <select required="" class="form-select form-select-sm mb-3" id="ward"
                                                    aria-label=".form-select-sm">
                                ...
                                <!--CREDIT CART PAYMENT-->
                                <div class="panel panel-info">
                                    <div class="panel-heading"><span><i class="fa fa-cc-visa"></i></span>&nbsp;Thông tin
                                        thanh toán</div>
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-md-12"><strong>Phương thức thanh toán:</strong></div>
                                            <div class="col-md-12">
                                                <select onchange="methodChanged(this)" id="CreditCardType" name="Method"
                                                    class="form-control">
                                        ...
                                        <div id="cre" style="display: none">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12"><input disabled="" type="text"
                                                        class="form-control" id="car_number" name="car_number"
                                                        value="" /></div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12"><strong>Card CVV:</strong></div>
                                                <div class="col-md-12"><input disabled="" type="text"
                                                        class="form-control" id="car_code" name="car_code" value="" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <select disabled="" class="form-control" id="car_month"
                                                        name="car_month">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <select disabled="" class="form-control" id="car_year"
                                                        name="car_year">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <button onclick="checkout()" class="btn btn-primary btn-submit-fix">Đặt
                                                    hàng</button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <footer style="
                text-align: center;
                margin-bottom: 1%;">Checkout by Công</footer>
