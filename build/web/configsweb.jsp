                                    ...
                                    <div style="margin-top: 1rem!important;" class="container px-5 my-5">
                                        <form id="contactForm" >
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="tenWebsite" type="email" placeholder="Tên website" data-sb-validations="required,email" />
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="diaChỉSốDường" type="text" placeholder="Đia chỉ số, đường" data-sb-validations="required" />
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="dịaChỉThanhPhố" type="text" placeholder="Địa chỉ thành phố" data-sb-validations="required" />
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="sốDiệnThoại" type="text" placeholder="Số điện thoại" data-sb-validations="required" />
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="facebook" type="text" placeholder="Facebook" data-sb-validations="required" />
                                                <div class="invalid-feedback" data-sb-feedback="facebook:required">Facebook is required.</div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <label for="instagram">Instagram</label>
                                                <input class="form-control" id="instagram" type="text" placeholder="Instagram" data-sb-validations="required" />
                                                <div class="invalid-feedback" data-sb-feedback="instagram:required">Instagram is required.</div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <label for="zalo">Zalo</label>
                                                <input class="form-control" id="zalo" type="text" placeholder="Zalo" data-sb-validations="required" />
