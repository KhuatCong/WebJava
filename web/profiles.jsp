                ...
                <form style="display: contents;" action="change" method="post">
                    <div class="col-md-3 border-right"> 
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                            <div class="abc" style="width: 230px; height: 270px; overflow: hidden">
                                <img id="image" style="width: 100%; height: 100%; " class="rounded-circle mt-5" src="${sessionScope.account.img}">

                            </div>
                            <center><input style="    width: 100%;
                                           margin-top: 6%;
                                           margin-left: 4%;
                                           padding: 4%;" class="text-black-50" type="file" id="imageFile" name="file"/></center>
