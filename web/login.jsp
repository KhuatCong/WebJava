            ...
            <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
                <div class="panel panel-info" >
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="forgotPassword.jsp">Quên mật khẩu?</a></div>
                    </div>     
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="login" method="post">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <input value="admin" id="login-username" type="text" class="form-control" name="usernameLogin" required value="" placeholder="Username or email">                                        
                            </div>

                            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                <input value="123" id="login-password" type="password" class="form-control" name="passwordLogin" required placeholder="Password">
                            </div>
