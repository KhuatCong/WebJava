...
public class OrderDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String orderFor = request.getParameter("for");
        request.setAttribute("orderfor", orderFor);
        HttpSession session = request.getSession();
        if ("user".equals(orderFor)) {
            ...
            try {
                ...
                OrderDAO ordao = new OrderDAO();
                    request.setAttribute("order", ordao.getOrderByID(orderid));
                    request.setAttribute("listdetail",ordao.getOrderDetailForID(orderid));
            } catch (Exception e) {
            }
        }
